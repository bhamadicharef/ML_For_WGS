...
###############################################################################
para_xgb = {'objective':'reg:squarederror', 'colsample_bytree': 0.8,
            'learning_rate': 0.1, 'min_split_loss':0, 'max_depth': 6,
            'subsample': 0.8, 'min_child_weight': 1, 'alpha':0,
            'n_estimators': 4000} 
###############################################################################
...
#------------------------------------
columnpred=df.columns.to_list()+['CO_xgboost']
